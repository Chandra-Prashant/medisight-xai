...
## 💡 The Problem
Deep Learning models in healthcare often act as **"Black Boxes"**—they provide a diagnosis (e.g., "Pneumonia") without explaining *why*. This lack of interpretability prevents clinicians from trusting AI tools in high-stakes environments.
...
Low False Negative rate (Type II Error) is prioritized for screening safety.	Achieved an AUC of 0.87, indicating strong discrimination capability.
